    ...
    const form = (
        <div>
            ...
            <TextField
                ...
                rowsMax={4}
            /> 
            <TextField value={props.category} type="text" name="category" title="Category" floatingLabelText="Cateogory" onChange={props.handleChange} />
            <TextField value={props.action} type="text" name="action" title="Action" floatingLabelText="Action" onChange={props.handleChange} />
            <TextField value={props.label} type="text" name="label" title="Label" floatingLabelText="Label" onChange={props.handleChange}/><br></br>
